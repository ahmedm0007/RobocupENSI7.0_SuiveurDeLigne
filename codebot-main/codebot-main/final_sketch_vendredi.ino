...
Robot_States ROBOT_CurrentState_en=bfollower4;
...
{ 
  ...
  BleftSpeed = 100- Bcorrection; //80 for the infinity state 100 for the rest of states 
  BrightSpeed = 100+ Bcorrection;
